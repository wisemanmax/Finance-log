...
export const DARK_THEME = {
  ...
  accent: "#00f5a0", accent2: "#00d9f5", warn: "#ff9f43", danger: "#ff6b6b", purple: "#a78bfa", gold: "#fbbf24",
  text: "#e8e8ec", text2: "#8b8b9e", text3: "#4a4a5c",
...
export const LIGHT_THEME = {
  ...
  accent: "#059669", accent2: "#0891b2", warn: "#d97706", danger: "#dc2626", purple: "#7c3aed", gold: "#d97706",
  text: "#1a1a2e", text2: "#4a4a5c", text3: "#8b8b9e",
  font: "'Outfit', sans-serif", mono: "'JetBrains Mono', monospace",
  sheetBg: "linear-gradient(180deg,#ffffff,#f0f0f5)", navBg: "rgba(245,245,247,0.95)", mode: "light",
};
export const V = { ...(LS.get("fl-theme") === "light" ? LIGHT_THEME : DARK_THEME) };
